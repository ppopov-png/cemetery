...
export function LiveWorldMapPanel({ videoRef, onClose }: { videoRef: RefObject<HTMLVideoElement | null>; pose: SpatialPose | null; trackingState: SpatialTrackingState; onClose: () => void; onSingleView: () => void }) {
